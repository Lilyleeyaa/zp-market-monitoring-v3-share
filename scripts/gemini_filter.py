...
1. 의약품 유통 (Distribution & Logistics) - 가중치 높음
   - 경쟁사 동향: 지오영, 백제약품 등 주요 유통사의 물류 센터 확장, M&A, 신규 계약, IT 인프라 투자
   - 유통 구조 변화: 직거래 비중 변화, 온라인몰 확장, 콜드체인 규제 변화

2. 커머셜 (Commercial & Solution) - 가중치 높음
   - 고객사(제약사) 동향: 외자사 및 국내사의 신약 출시, 파이프라인 변경, 한국 시장 철수/진출
   - 전략적 파트너십: 공동판매, 코마케팅, 판권 이전

3. 약가 및 제도: 보건복지부/심평원의 약가 인하 정책, 급여 등재 이슈, 리베이트 규제

4. 기업 전략 (M&A): 주요 고객사나 경쟁사의 인수합병, 지분 투자, 전략적 제휴

[Filtering Rules]
- 감점 요인: 단순 CSR 활동, 단순 인사 동정(임원급 제외), 일반 건강 정보, 반복된 화제성 기사
- 가점 요인: '쥴릭파마' 직접 언급, 글로벌 본사 전략 변화, 경쟁사 독점 계약
"""
